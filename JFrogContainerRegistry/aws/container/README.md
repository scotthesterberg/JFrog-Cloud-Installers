...
```docker run -d -p 8081:8081 117940112483.dkr.ecr.us-east-1.amazonaws.com/3701884c-2c08-41f3-b4df-84743c6a9f58/9220cef5-c1d4-476f-af41-426f6b16012c/partnership-public-images.jfrog.io/aws/artifactory-jcr:7.7.3-latest```
...
```docker run -d -p 8081:8081 --env ARTIFACTORY-PASSWORD=<PASSWORD> 117940112483.dkr.ecr.us-east-1.amazonaws.com/3701884c-2c08-41f3-b4df-84743c6a9f58/9220cef5-c1d4-476f-af41-426f6b16012c/partnership-public-images.jfrog.io/aws/artifactory-jcr:7.7.3-latest```
