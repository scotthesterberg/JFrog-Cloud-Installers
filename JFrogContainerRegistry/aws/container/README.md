...
```docker run -d -p 8081:8081 403495124976.dkr.ecr.us-east-1.amazonaws.com/3701884c-2c08-41f3-b4df-84743c6a9f58/cg-3988177827/solengha-docker-aws.jfrog.io/jfrog/artifactory-jcr:6.16.0-latest```
...
```docker run -d -p 8081:8081 --env ARTIFACTORY-PASSWORD=<PASSWORD> 403495124976.dkr.ecr.us-east-1.amazonaws.com/3701884c-2c08-41f3-b4df-84743c6a9f58/cg-3988177827/solengha-docker-aws.jfrog.io/jfrog/artifactory-jcr:6.16.0-latest```
